		...
		<nav  class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="/BApp/web/item/index"><i class="fa fa-venus "></i>Item Page </a>
                        
                    </li>
                    
                    <li>
                        <a href="/BApp/web/customer/index"><i class="fa fa-bolt "></i>Customer Details </a>
                        
                    </li>
                   
                     
                     <li>
                        <a href="/BApp/web/category/index"><i class="fa fa-code "></i>Category</a>
                    </li>
